...
+ Copy the value for the VCAP_SERVICES environment variable from the application running in Bluemix and paste it in a `vcap-local.json` file
...
=======
# tfa-bot
>>>>>>> 28416ec68e3bece326e68557aaa98bef84d4acbb
